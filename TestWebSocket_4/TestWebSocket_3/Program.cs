    ...
    public class Program
    {
        ...
        private static void StartClient()
        {
            ...
            try
            {
                ...
                Send(client, "WSC01 CLIENTE: ENVIANDO ZPL CODE PARA O SERVIDOR WEBSOCKET...<EOF>. |" + lines[0].ToString() + Environment.NewLine + DateTime.Today.ToString() + "|");
                sendDone.WaitOne();
        ...
        public static void Main(String[] args)
        {
            ...
            Console.WriteLine("|" + "WEBSOCKET CLIENTE 01 Iniciado... " + DateTime.Now.ToString() + "|");
            Console.WriteLine("**** ENVIO DE ARQUIVOS ZPL CODE PARA O WEBSOCKET *** ");
            Console.WriteLine(" ");
            Console.WriteLine("*** PRESSIONE ENTER PARA FECHAR O CLIENT CONSOLE 01  *** ");
            Console.ReadLine();
        ...
        {
            Console.WriteLine("|" + "CLIENTE 01: INICIADO ENVIO DE DADOS... " + DateTime.Today.ToString() + "|");
            Console.WriteLine(" ");
            StartClient();
